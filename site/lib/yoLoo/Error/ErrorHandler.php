 ...
 */
class ErrorHandler implements \yoLoo\Error\ErrorHandlerInterface {
    ...
    public function handleError($errorLevel, $errorMessage, $errorFile, $errorLine) {
        ...
        if (in_array($errorLevel, (array)$this->exceptionalErrors)) {
            if (class_exists('\yoLoo\Error\Exception')) {
                throw new \yoLoo\Error\Exception($errorLevels[$errorLevel] . ': ' . $errorMessage . ' in ' . $errorFile . ' line ' . $errorLine, 1);
            } else {
