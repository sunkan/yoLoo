 ...
 */
class DebugExceptionHandler extends \yoLoo\Error\AbstractExceptionHandler {
...
//        $moreInformationLink = ($exceptionCodeNumber != '') ? '(<a href="http://typo3.org/go/exception/' . $exception->getCode() . '">More information</a>)' : '';
        ...
        echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN"
            ...
            <div style="
                    ...
                    padding: 0;
                ">
                <div style="width: 100%; background-color: #515151; color: white; padding: 2px; margin: 0 0 6px 0;">Uncaught Exception in yoLoo</div>
                <div style="width: 100%; padding: 2px; margin: 0 0 6px 0;">
                    ...
                    <br />
<!--                    <a href="' . $createIssueLink . '">Go to the FORGE issue tracker and report the issue</a> - <strong>if you think it is a 
bug!</strong><br />-->
                    <br />
                    ' . $backtraceCode . '
                </div>
                ...
                if (isset($step['args']) && is_array($step['args'])) {
                    foreach ($step['args'] as $argument) {
                        ...
                        if (is_object($argument)) {
                            ...
                            $preparedArgument = str_replace("â€¦", '<span style="color:white;">â€¦</span>', $preparedArgument);
                            $preparedArgument = str_replace("\n", '<span style="color:white;">âŽ</span>', $preparedArgument);
            ...
            if (is_array($phpFile)) {
                ...
                if ($endLine > $startLine) {
                    ...
                    for ($line = $startLine; $line < $endLine; $line++) {
                        ...
                        $codeLine = str_ireplace(array('&lt;?php',"\n"), '', highlight_string('<?php '.$codeLine, true));
                        if ($line === $lineNumber) {
